...
```{r get-abstracts}
ncbiurl <- "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi"
publications <- GET(
...
institution <- str_extract_all(
  publications_txt,
  "University\\s+of\\s+[[:alpha:]\\s]+|[[:alpha:]]+\\s+Institute\\s+of\\s+[[:alpha:]]+"
  ) 
